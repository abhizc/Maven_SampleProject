...
// Secrects should come from the UI
// Linux user credentials
def wls_cred = ['914e4704-14d8-4b0c-a3ef-31158f8dc67d', '914e4704-14d8-4b0c-a3ef-31158f8dc67d', '914e4704-14d8-4b0c-a3ef-31158f8dc67d']
        ...
        stage('Build') {
            ...
            post {
                success {
                    ...
                    nexusPolicyEvaluation iqApplication: "${iqApplication ?: depArtifactId}", iqStage: 'build'
                    // save artifacts
